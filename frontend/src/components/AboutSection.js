...
const AboutSection = () => {
  ...
  return (
    <section id="about" data-testid="about-section" className="py-24 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p data-testid="about-description" className="text-lg text-gray-700 mb-6 leading-relaxed">
