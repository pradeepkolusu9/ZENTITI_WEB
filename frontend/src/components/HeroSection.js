    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <Button
          ...
          size="lg"
          className="bg-white text-blue-600 hover:bg-gray-100 text-lg px-8 py-6 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
        >
          Get in Touch
