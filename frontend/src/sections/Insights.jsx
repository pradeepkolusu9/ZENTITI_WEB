        ...
        {INSIGHTS.map((insight, index) => (
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">{insight.excerpt}</p>
              <Button
                ...
                iconPosition="right"
                className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 p-0 hover:scale-100"
              >
                Read More
              </Button>
            </Card>
